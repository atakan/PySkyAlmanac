...
obsTZ = pytz.timezone('EET') # Turkey and TRNC use Eastern European Time: UTC+2 normal time, +3 summer time
...
mercury.rising_text = [
[0.22, 'Merkür', 'doğuyor', -1, False],
[0.51, 'Merkür', 'doğuyor', -1, False],
[0.82, 'Merkür', 'doğuyor', -1, True]
]
venus.rising_text = [
[0.67, 'Venüs doğuyor', '~', 0, False]
]
mars.rising_text = [
[0.71, '~', 'Mars doğuyor', -2, False]
]
jupiter.rising_text = [
[0.08, '~', 'Jüpiter doğuyor', -1, False],
[0.9, 'Jüpiter doğuyor', '~', 0, False]
]
saturn.rising_text = [
[0.20, 'Satürn doğuyor', '~', 0, False],
[0.94, '~', 'Sat. doğ.', -1, False]
]
uranus.rising_text = [
[0.5, 'Uranüs doğuyor', '~', -1, False]
]
neptune.rising_text = [
[0.29, 'Neptün doğuyor', '~', 0, False]
]
m31.rising_text = [
...
[0.15, 'Jüpiter meridyende', '~', 0, False],
[0.975, '~', 'Jüp. mrd.', 0, False]
]
saturn.transit_text = [
[0.28, '~', 'Satürn meridyende', -1, False]
]
uranus.transit_text = [
[0.045, '~', 'Uran. mrd.', -1, False],
[0.86, '~', 'Uranüs meridyende', -1, False]
]
neptune.transit_text = [
[0.7, 'Neptün meridyende', '~', 0, False]
]
m31.transit_text = [
[0.04, 'M31 mrd.', '~', 0, False],
[0.77, 'M31 meridyende', '~', 0, False]
]
m45.transit_text = [
[0.087, 'M45 meridyende', '~', 0, False],
...
[0.12, '~', 'Antares meridyende', -1, False],
[0.946, '~', 'Antares meridyende', -1, False]
]
arcturus.transit_text = [
[0.24, 'Arcturus meridyende', '~', 0, False]
]
pollux.transit_text = [
[0.14, 'Pollux meridyende', '~', -1, False],
[0.87, '~', 'Pollux meridyende', -1, False]
]
deneb.transit_text = [
[0.75, '~', 'Deneb meridyende', 0, False],
]

mercury.setting_text = [
[0.09, 'Merkür', '~', -1, False],
[0.07, 'bat.', '~', -1, False],
[0.39, 'Merkür', 'batıyor', -1, False],
[0.65, 'Merkür', '~~batıyor', -1, False],
[0.957, 'Merkür', 'batıyor', -1, True]
]
venus.setting_text = [
[0.33, 'Venüs batıyor', '~', 0, True],
]
mars.setting_text = [
[0.22, 'Mars batıyor', '~', 0, False]
]
jupiter.setting_text = [
[0.45, '~', 'Jüpiter batıyor', -1, False],
]
saturn.setting_text = [
[0.7, '~', 'Satürn batıyor', -1, False]
]
uranus.setting_text = [
[0.10, 'Uranüs batıyor', '~', -1, False],
[0.87, 'Uranüs batıyor', '~', -1, False]
]
neptune.setting_text = [
[0.12, '~', 'Neptün batıyor', -1, False],
[0.87, '~', 'Neptün batıyor', -1, False]
]
m31.setting_text = [
[0.15, '~', 'M31 batıyor', -1, False],
[0.93, 'M31 batıyor', '~', 0, False]
]
m45.setting_text = [
[0.14, '~', 'M45 batıyor', 0, False],
[0.930, 'M45 batıyor', '~', -4, False]
]
m42.setting_text = [
[0.13, '~', 'M42 batıyor', 0, False],
