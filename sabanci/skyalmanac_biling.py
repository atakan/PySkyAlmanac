...
from local_info_SabanciUniv_2012 import obs, obsTZ, utcTZ, year
from local_info_SabanciUniv_2012 import begin_day, begin_day_datetime, no_days
from local_info_SabanciUniv_2012 import first_sunday, first_sunday_datetime
from local_info_SabanciUniv_2012 import rising_bodies, transit_bodies, setting_bodies
...
#c.writePDFfile("almanac_%d_SabanciUniv" % (year))
c.writeEPSfile("almanac_%d_SabanciUniv" % (year))
