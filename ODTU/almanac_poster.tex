...
\shorthandoff{=}
~\vskip .1cm
\centerline{\raisebox{-24pt}{\includegraphics[clip,height=68pt]{logo_tr}}
     \fontsize{36pt}{36pt}\selectfont
     \,için Gökyüzü Almanağı / Sky Almanac for\,
\raisebox{-24pt}{\includegraphics[clip,height=68pt]{logo_en}}}
\vskip 1cm
\noindent
\centerline{\includegraphics[clip,height=0.9\textheight]{almanac_2017_ODTU_Fizik}}
...
{\hfill \url{https://github.com/atakan/PySkyAlmanac/tree/master/ODTU}}
\end{document}
