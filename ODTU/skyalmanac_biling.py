...
from local_info_ODTU_2017 import obs, obsTZ, utcTZ, year
from local_info_ODTU_2017 import begin_day, begin_day_datetime, no_days
from local_info_ODTU_2017 import first_sunday, first_sunday_datetime
from local_info_ODTU_2017 import rising_bodies, transit_bodies, setting_bodies
...
#          '05:00', '06:00', '07:00']) :
for i, tlab in enumerate(['18', '19', '20',
...
#c.writePDFfile("almanac_%d_ODTU_Fizik" % (year))
c.writeEPSfile("almanac_%d_ODTU_Fizik" % (year))
